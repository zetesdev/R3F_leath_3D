...
function About({ showAbout, setShowAbout }) {
  ...
  return (
    <>
      ...
      >
        <div className='flex flex-col items-center p-2 m-2   bg-white shadow-2xl lg:flex-row lg:space-y-0 lg:space-x-10 lg:m-0 lg:p-16'>
          <div className='flex flex-col lg:mb-4 space-y-3 text-center lg:text-md lg:text-left'>
